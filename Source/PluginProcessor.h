...
private:
    juce::AudioProcessorValueTreeState parameters; // ’Ç‰Á

    std::atomic<float>* gain = nullptr; // ’Ç‰Á
    std::atomic<float>* panRule = nullptr; // ’Ç‰Á
    std::atomic<float>* panAngle = nullptr; // ’Ç‰Á
    std::atomic<float>* limit = nullptr; // ’Ç‰Á2
    //==============================================================================
